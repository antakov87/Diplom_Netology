...
public abstract class CardPages {
    ...
    public void enterInputs(DataHelper.CardInfo info) {
    ...
    public void enterValidUserWithIncorrectCard(DataHelper.CardInfo info) {
        enterInputs(info);
        errorNotification.shouldBe(visible, ofSeconds(15));
    }

    public void enterIncorrectCardInput(DataHelper.CardInfo info, String errorText) {
        enterInputs(info);
        errorCardInput.shouldBe(visible).shouldHave(text(errorText));
    }

    public void enterIncorrectMonthInput(DataHelper.CardInfo info, String errorText) {
        enterInputs(info);
        errorMonthInput.shouldBe(visible).shouldHave(text(errorText));
    }

    public void enterIncorrectYearInput(DataHelper.CardInfo info, String errorText) {
        enterInputs(info);
        errorYearInput.shouldBe(visible).shouldHave(text(errorText));
    }

    public void enterIncorrectNameInput(DataHelper.CardInfo info, String errorText) {
        enterInputs(info);
        errorNameInput.shouldBe(visible).shouldHave(text(errorText));
    }

    public void enterIncorrectCodeInput(DataHelper.CardInfo info, String errorText) {
        enterInputs(info);
